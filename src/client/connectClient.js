      ...
      try {
        ...
        await updateDoc(clientRef, {
          ...
          documents: arrayUnion({
            ...
            description,
            coachId,
            coachName: selectedTimeSlot.timeSlot.coachName || "Unknown Coach",  // Ensure this exists
            price,
        ...
        console.log(`Successfully chose coach ID: ${coachId} at ${date} - ${time}`);
        alert("You have chosen this coach and the time slot!");
  
        setSelectedTimeSlot(null);
        setClientWallet(prev => prev - price);
      } catch (error) {
        console.error("Error updating selected coach or time slot: ", error.message);
        alert("There was an error choosing the coach. Please try again.");
      }
    }
  };
